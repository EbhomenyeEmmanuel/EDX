   ...
   public static void main (String args []){
    ...
    public static void intro(){
     ...
     public static void travelTimeAndBudget(){
        ...
        System.out.print("What is the three letter curency symbol for your travel destination :");
    ...
    public static void finalDestinationCalculation(){
